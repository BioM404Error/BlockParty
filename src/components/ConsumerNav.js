      ...
      <Navbar bg="primary" variant="dark">
        ...
        <Navbar.Collapse id="consumer-navbar-nav">
          <Nav className="mr-auto">
            <Nav.Link as={Link} to="/specification">
              Specifications
            </Nav.Link>
            <Nav.Link as={Link} to="/permit">
              Permit
            </Nav.Link>
            ...
            <NavDropdown title="Selections" id="basic-nav-dropdown">
              ...
              <NavDropdown.Divider />
              <NavDropdown.Item as={Link} to="/selections/Entertainment">
                Entertainment
              </NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/selections/Food">
                Food
              </NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/selections/Clothing">
                Clothing
              </NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/selections/Cosmetics">
                Cosmetics
              </NavDropdown.Item>
            </NavDropdown>
          </Nav>
